...
int main()
{
    ...
    Planet neptune(5.0f, 0.51f, 1.0f, 0.5f, glm::vec3(0, 1, 0), "..\\Textures\\neptunemap.jpg");
    Planet earth(10.0f, 0.71f, 1.2f, 2.0f, glm::vec3(0, 1, 0), "..\\Textures\\earthmap1k.jpg");
    Planet mars(15.0f, 0.91f, 1.1f, 3.5f, glm::vec3(0, 1, 0), "..\\Textures\\marsmap1k.jpg");
    Planet venus(20.0f, 1.3f, 0.8f, 5.0f, glm::vec3(0, 1, 0), "..\\Textures\\venusmap.jpg");
    Planet jupiter(25.0f, 1.4f, 0.8f, 7.0f, glm::vec3(0, 1, 0), "..\\Textures\\jupitermap.jpg");
